...
<section id="about" class="section border-block __up">
  <div class="container">
    <div class="row" style ="margin-bottom:125px;">
      ...
      <div class="col-md-4">
          <a href = "<?php echo get_field('file')['url']; ?>" target="_blank" class = "btn btn-lg btn-primary btn-download"> Download Credit Application </a>
      </div>  
      <div class="col-md-8">
      ...
      <div class="col-md-8">
        <div class="loan-content">
          ...
          <p>
            • Completion of CFA application (<a href="<?php echo get_field('file')['url']; ?>" target="_blank" class ="link">Click here to Download Application</a>)<br>
